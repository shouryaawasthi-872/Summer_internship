...
export const cgpaAPI = {
  /** Get CGPA history records (role-filtered; optional ?studentId=) */
  getAll:          (params) => api.get('/cgpa', { params }),
  /** Get students list with their currentCGPA (mentor / admin) */
  getStudents:     ()       => api.get('/cgpa/students'),
  /** Upsert a semester CGPA entry */
  upsert:          (d)      => api.post('/cgpa', d),
  /** Delete a CGPA record by id (admin only) */
